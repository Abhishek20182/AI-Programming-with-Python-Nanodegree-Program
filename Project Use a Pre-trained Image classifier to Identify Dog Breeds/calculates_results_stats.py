...
def calculates_results_stats(results_dic):
    ...
    #           number of correctly matched images ('n_correct_notdogs') divided by the 
    #           number of images('n_images'). This result will need to be 
    #           multiplied by 100.0 to provide the percentage.
    #    
    # Calculates % correct for matches
    results_stats_dic['pct_match'] = (results_stats_dic['n_correct_notdogs'] / results_stats_dic['n_images'])*100.0
